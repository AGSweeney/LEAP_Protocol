    ...
    size_t                       payload_length)
{
    ...
    if (stack != NULL)
    {
        leap_device_stack_notify_tx_ok(stack, leap_raw_winpcap_monotonic_us());
    }
...
int main(int argc, char** argv)
{
    ...
    if (leap_win_handle_version_arg(argc, argv, "leap_win_device") != 0)
    {
        return 0;
    }
    ...
    leap_build_info_print(stdout, "leap_win_device");
