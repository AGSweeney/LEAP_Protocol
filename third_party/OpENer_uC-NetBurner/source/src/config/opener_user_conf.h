/*******************************************************************************
 * Default OpENer configuration for embedded builds.
 *
 * Product firmware should override via source/src/ports/netburner/app/opener_user_conf.h
 * on the include path BEFORE this file (see app/nbeclipse/makefile.init.snippet).
 ******************************************************************************/
...
/** Match NNDK default tick (TICKS_PER_SECOND=20 → 50 ms). Drive opener_process at this rate. */
static const MilliSeconds kOpenerTimerTickInMilliSeconds = 50;
