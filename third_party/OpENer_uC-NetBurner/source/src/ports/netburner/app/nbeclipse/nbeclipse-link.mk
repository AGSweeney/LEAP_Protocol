# OpENer static libraries for NBEclipse.
# Include from project makefile.targets after objects.mk has set LIBS.
...
$(OPENER_LIBS_STAMP): $(OPENER_ROOT)/source/CMakeLists.txt
	@echo "Building OpENer Core libraries for $(PLATFORM)..."
