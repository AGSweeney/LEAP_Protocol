...
/** @brief Provide values for the Interface State (attribute #8) */
typedef enum {
  kEthLinkIfStateUnknown = 0x00,
  kEthLinkIfStateEnabled = 0x01,
  kEthLinkIfStateDisabled = 0x02,
  kEthLinkIfStateTesting = 0x03,
} CipEthLinkIfaceState;

/** @brief Provide values for the Admin State (attribute #9) */
typedef enum {
  kEthLinkAdminStateEnabled = 0x00,
  kEthLinkAdminStateDisabled = 0x01,
} CipEthLinkAdminState;
...
typedef struct {
  ...
  CipUsint interface_state; /**< Attribute #8: State of interface */
  CipUsint admin_state;     /**< Attribute #9: Administrative state */
...
/** Update instance 1 link status from platform PHY (NetBurner ifconfig hook). */
void CipEthernetLinkUpdateLinkStatus(CipUdint speed_mbps,
                                     CipBool full_duplex,
                                     CipBool link_up);

/** Update instance 1 Interface Counters (attribute 4). */
