...
/* Forward declare to avoid pulling platform socket headers into core types. */
struct sockaddr;
 ...
 *  @return           status of kEipStatusOk or kEipStatusError on failure
 */
typedef EipStatus (*CipCallback)(CipInstance *RESTRICT const instance,
 ...
 *   should be sent
 */
typedef EipStatus (*CipServiceFunction)(CipInstance *RESTRICT const instance,
                                        CipMessageRouterRequest *const
                                        message_router_request,
                                        CipMessageRouterResponse *const
                                        message_router_response,
