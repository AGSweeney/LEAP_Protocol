...
/** Network interface handle — opaque to the protocol core (NetBurner interface id). */
typedef OpenerNetIfHandle TcpIpInterface;
 ...
 */
EipStatus IfaceWaitForIp(TcpIpInterface iface,
                         int timeout,
 ...
 * Safe to call when compat is disabled (no-op).
 */
