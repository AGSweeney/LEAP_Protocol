...
/* agsweeney@gmail.com: provide safe fallback trace sink for library builds */
#ifndef LOG_TRACE
#include <stdio.h>
...
#warning OPENER_TRACE_LEVEL was not defined; defaulting to OPENER_TRACE_LEVEL_ERROR
