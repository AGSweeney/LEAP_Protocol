 ...
 * leap_disc_device.h
 *
 * Device-side LEAP-DISC handling (HELLO, IDENTIFY, LOCATE_DEVICE).
 *
...
#define LEAP_LOCATE_DURATION_MIN_MS     100u
#define LEAP_LOCATE_DURATION_MAX_MS     60000u
#define LEAP_LOCATE_DURATION_DEFAULT_MS 3000u
