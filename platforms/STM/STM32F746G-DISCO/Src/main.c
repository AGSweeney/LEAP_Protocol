...
static void LeapThread(void const * argument);
...
static void StartThread(void const * argument)
{
  ...
  {
    osThreadDef(Leap, LeapThread, osPriorityAboveNormal, 0, configMINIMAL_STACK_SIZE * 8);
    leap_host_bind_task_handle((void *)osThreadCreate(osThread(Leap), NULL));
  }
